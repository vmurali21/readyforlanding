       ...
       if (coordinates) {
         ...
         if (travelInfo) {
           ...
           if (currentTime >= eta) {
             ...
             setOutput(prev => [
               ...prev,
               "You should leave as soon as possible to try to get there on time!",
 ...
 return (
   <div className="App">
     ...
     {isLoaded && (
       ...
       >
         <GoogleMap
           mapContainerStyle={{ height: '200%', width: '200%' }}
           center={mapCenter || { lat: 37, lng: -122 }}
           zoom={10}
